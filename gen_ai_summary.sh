...
export PATH=/Users/bruce/Library/Python/3.9/bin:$PATH
...
gen_podcast_mp3_url() {
    ...
    # local tts_cmd="uv run gentts_emo.py --all -v ning.wav -f \"$abs_podcast_script\" -o \"$mp3_full_path\""
